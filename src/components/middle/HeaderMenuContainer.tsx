      ...
      <div className="HeaderMenuContainer">
        ...
        >
          ...
          {canShowBoostModal && !canViewBoosts && (
            <MenuItem icon="boost-outline" onClick={handleBoostClick}>
              {lang(
                isChannel
          ...
          {canAddContact && (
            <MenuItem icon="add-user" onClick={handleAddContactClick}>
              {lang("AddContact")}
            </MenuItem>
          )}
          {isMobile && canCall && (
            <MenuItem icon="phone" onClick={handleCall}>
              {lang("Call")}
            </MenuItem>
          )}
          {canCall && (
            <MenuItem icon="video-outlined" onClick={handleVideoCall}>
              {lang("VideoCall")}
            </MenuItem>
          )}
          {canMute &&
          ...
          {!withForumActions && (
            <MenuItem icon="select" onClick={handleSelectMessages}>
          ...
          {canViewStatistics && (
            <MenuItem icon="stats" onClick={handleStatisticsClick}>
              {lang("Statistics")}
            </MenuItem>
          )}
          {isChannel && canViewMonetization && (
            <MenuItem icon="cash-circle" onClick={handleMonetizationClick}>
          ...
          {canReportChat && (
            <MenuItem icon="flag" onClick={handleReport}>
...
export default memo(
  withGlobal<OwnProps>((global, { chatId, threadId }): StateProps => {
    ...
    const canReportChat =
      isMainThread && !user && (isChatChannel(chat) || isChatGroup(chat));
    ...
    const savedDialog = isSavedDialog
      ? selectChat(global, String(threadId))
      : undefined;
    ...
    return {
      ...
      botPrivacyPolicyUrl: chatBot
        ? userFullInfo?.botInfo?.privacyPolicyUrl
        : undefined,
      isChatInfoShown:
